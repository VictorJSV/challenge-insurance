...
describe('Button component', () => {
  ...
  it('when applying variant prop, then adds the correct CSS classes', () => {
    render(<Button variant="filled">Accent</Button>);
    const button = screen.getByRole('button');
    expect(button).toHaveClass('c-button');
    expect(button).toHaveClass('c-button--variant-filled');
  });
  ...
  it('when passing HTML props, then forwards them to button element', () => {
    render(<Button variant="filled" type="submit" disabled>Submit</Button>);
    const button = screen.getByRole('button');
  ...
  it('when clicking the button, then calls onClick handler', () => {
    ...
    render(<Button variant="filled" onClick={handleClick}>Click</Button>);
